		...
		return (
			<div className="content">
				...
				<div className="inventory">
					<div> <h1> Liste des véhicules </h1> </div>
					<Product
						edit
						add
						{
				...
				<div className="store">
					<div><h1>Auras-tu assez d'argent ...</h1></div>
					{
						this.props.store.items.map((item) => {
							return (
								<Product
				...
				<div className="cart">
					<div> <h1> Le porte-feuille fume! </h1> </div>
					<ul>
						{
					...
					<div>
						{
							order.length > 0 ?
								...
								>
									...
									<button
										onClick={() => this.props.store_valid_cart()} className="ajoute-au-panier">
										Valider
									</button>
								</div>
